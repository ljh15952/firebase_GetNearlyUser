...
public class LocationMng : MonoBehaviour
{
  ...
  //  double detailed_num = 1.0;//기존 좌표는 float형으로 소수점 자리가 비교적 자세히 출력되는 double을 곱하여 자세한 값을 구합니다.
    ...
    void RetrieveGPSData()
    {
        ...
        text_latitude = currentGPSPosition.latitude;//위도 값을 받아,텍스트에 출력합니다
        text_longitude = currentGPSPosition.longitude;//경도 값을 받아, 텍스트에 출력합니다.
    }
}